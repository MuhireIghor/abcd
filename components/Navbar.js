...
const Navbar = () => {
  return (
    <div style={{backgroundImage:`url('../public/images/bg1.png')`,
    ...
    <div className='flex flex-col  justify-center items-center '>
      <p className='text-4xl text-white font-black tracking-wider'>Find The Perfect Real Estate Agent</p>
      <p className='text-white text-md w-[35%] text-center mt-4'>Make your search and sale easier and faster by connecting with one of our expert local agent in your neighborhood</p>
...
<input type='text' className=' w-[80%]  p-1 mx-4 outline-none border-none' />
