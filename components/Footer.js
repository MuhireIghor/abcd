    ...
    <div className="bg-footerBlue flex flex-col gap-2  w-screen" >
      ...
      <div className="flex flex-col basis-1/4 ">
        <div className='flex flex-row gap-3 '>
          <div className='w-5'>
            <Image src={HouseGrp} width={8} height={10} layout='responsive' alt='HouseVector' />
          </div>
      ...
      <div className='flex flex-col basis-1/4'>
        ...
        <div className='flex flex-col gap-[12px]'>
          ...
          {links.map((link, index) => {
            if (index == 4) {
              return (
                <p className='text-white hover:underline hover:decoration-solid hover:decoration-1 hover:cursor-pointer '>{link} <span className='text-orangeFooter font-hiring non-italic'> We 're hiring</span></p>

                )
              } else {

              return (
                <p className='text-white  hover:underline hover:decoration-solid hover:decoration-1 hover:cursor-pointer  '>{link}</p>
              )
            }
      ...
      <div className='flex flex-col basis-1/4'>
        ...
        <div className='flex flex-col gap-[12px]'>
          {agentBook.map((book) => {
            return (
              <p className='text-white hover:underline hover:decoration-solid hover:decoration-1 hover:cursor-pointer '>{book}</p>
            )
          })}
        </div>
      ...
      <div className='flex flex-col basis-1/4'>
        ...
        <div className='flex flex-col gap-[12px]'>
          {resources.map((resource)=>{
            return(
              <p className='text-white hover:underline hover:decoration-solid hover:decoration-1 hover:cursor-pointer'>{resource}</p>
              )
          })}
